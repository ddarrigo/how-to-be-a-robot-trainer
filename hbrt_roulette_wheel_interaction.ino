//allungare i tempi di oblio
//somma vettoriale
//lavoro sui suoni-melodie multiciclo senza freezing vedi esempio built in del buzzer
  ...
  */
  ...
  if(IRindex>=4){
    ...
    */
    ...
    //choice="hunter"; //forcing choice just for arranging debugging
